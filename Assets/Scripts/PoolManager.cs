...
public class PoolManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        flyBulletPool = new ObjectPool<GameObject>(createFunc: () => { var obj = Instantiate(flyBulletPrefab); obj.SetActive(false); return obj; }, actionOnGet: (obj) => obj.SetActive(true), actionOnRelease: (obj) => obj.SetActive(false), actionOnDestroy: (obj) => Destroy(obj), collectionCheck: false, defaultCapacity: 256, maxSize: 512);
        destroyerBulletPool = new ObjectPool<GameObject>(createFunc: () => { var obj = Instantiate(destroyerBulletPrefab); obj.SetActive(false); return obj; }, actionOnGet: (obj) => obj.SetActive(true), actionOnRelease: (obj) => obj.SetActive(false), actionOnDestroy: (obj) => Destroy(obj), collectionCheck: false, defaultCapacity: 256, maxSize: 512);
        mommyBulletPool = new ObjectPool<GameObject>(createFunc: () => { var obj = Instantiate(mommyBulletPrefab); obj.SetActive(false); return obj; }, actionOnGet: (obj) => obj.SetActive(true), actionOnRelease: (obj) => obj.SetActive(false), actionOnDestroy: (obj) => Destroy(obj), collectionCheck: false, defaultCapacity: 256, maxSize: 512);
